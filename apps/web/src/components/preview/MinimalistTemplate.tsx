...
export function MinimalistTemplate({
  ...
  return (
    ...
    >
      ...
      {(() => {
        // Section blocks keyed by canonical id. The header (identity) above is
        // always rendered; these are the reorderable/hideable blocks, emitted
        // in the order resolved from the theme (resolveSectionOrder).
